...
This repository is the Straddle CLI (`straddle`). It was originally generated by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press) and is now maintained and released directly from this repo — there is no regeneration step. Keep edits narrow and document systemic divergences from the generated tree in the customization manifest described below.
